...
// Imports directly from src/assets for bundler compatibility
  ...
  return (
    <>
      ...
      <div style={styles.pageBackground}>
        {/* Rendered via imported image asset */}
        <img
          src={bgImage}
          alt="Background"
        ...
        <div className="glass-card" style={styles.card}>
          <div style={styles.headerContainer}>
            ...
            <p style={styles.subtitle}>Fill in your details to register a new workspace account</p>
          </div>
